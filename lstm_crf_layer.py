...
class BLSTM_CRF(object):
    def __init__(self, embedded_words, hidden_unit, cell_type, num_layers, dropout_rate,
        ...
        self.embedded_chars = embedded_words
        self.initializers = initializers
        self.seq_length = seq_length
        self.num_labels = num_labels
        self.labels = labels
        self.lengths = lengths
        self.embedding_dims = embedded_words.shape[-1].value
